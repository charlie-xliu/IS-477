...
Data Profile
Dataset 1: IMLS Public Library Survey (PLS), FY2023
...
and work-from-home rate (DP03_0042PE)
...
Clone the repository from charlie-xliu/IS-477 on GitHub.


Obtain the raw data files and place them in data/raw/:
...
Run the notebook by opening notebooks/01_cleaning_eda_features.ipynb in Jupyter and selecting Kernel → Restart & Run All. All intermediate CSV files, figures, and documentation will be written to their respective directories (data/processed/, figures/, docs/).


Verify outputs — the final cell of the notebook prints a checklist of expected output files. All items should show a checkmark (✓).
